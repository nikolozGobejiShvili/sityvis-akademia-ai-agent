...
- _planner_pre_answer
- main.py
- _extract_date_hint_from_message
...
Cohesion: 0.04
Nodes (55): _camp_off_suppresses_info(), _dedupe_child_age_questions(), _ensure_adult_intro_followup_for_parent_flow(), _ensure_camp_age_question(), _format_multipoint_paragraphs(), _handle_core(), _has_any_child_age_question(), _is_active_per_product_booking() (+47 more)
...
### Community 13 - "Lead"
Cohesion: 0.07
Nodes (55): Client, EmailMessage, Lead, _adult_detail_lines(), _booking_text(), _build_adult_summary(), _build_email_subject(), _build_parent_summary() (+47 more)
...
Cohesion: 0.04
Nodes (75): _apply_privacy_notice_policy(), _attempt_booking(), _book_selected_slot(), _booking_success_this_turn(), _compose_or_fallback(), _detect_safe_intent(), _end_with_consultation_offer(), _exact_detail_already_general() (+67 more)
...
Cohesion: 0.08
Nodes (28): _answer_camp_part(), _camp_price_question_count(), _camp_price_value(), _final_camp_policy_has_recent_camp_context(), _is_camp_price_intent(), _is_camp_registration_link_request(), _is_mixed_camp_adult_request(), _is_payment_question() (+20 more)
...
Cohesion: 0.03
Nodes (111): _active_configured_camp_streams(), _approved_camp_copy(), _bank_genitive(), _book_fast_track_registration_url(), _bot_last_gave_payment_method_answer(), _camp_future_information_not_announced_answer(), _camp_installments_months(), _camp_payment_process_answer() (+103 more)
...
### Community 107 - "_extract_date_hint_from_message"
Cohesion: 0.50
Nodes (4): _extract_date_hint_from_message(), Live QA Patch (2026-06-05) — Bug 5 CRITICAL.      Pull a *target date* out of, Return the offered slot the user explicitly picked, or None.      Uses ``paren, _user_explicit_slot_choice()
...
- **Why does `ParentToolExecutor` connect `ParentToolExecutor` to `_ensure_lead`, `run_parent_llm_turn`, `Lead`, `Conversation`, `ProgramId`?**
