...
TOPIC_TOOLS: list[dict[str, Any]] = [
    {"type": "function", "function": {
        ...
        "description": (
            ...
            "გაჯეტები, სამედიცინო, მშობელთან კომუნიკაცია, განთავსება, დასვენება და სხვ.). "
            "გამოიძახე, როცა მშობელი ამ თემებზე კითხულობს — უპასუხე დაბრუნებული "
            "ფაქტებით, ბუნებრივად, არ გამოიგონო."
        ),
        "parameters": {"type": "object", "properties": {
            "topic": {"type": "string", "description": "თემის სახელი — ქართულად ან ინგლისურად (safety/უსაფრთხოება, food/კვება, medical/სამედიცინო და სხვ.)."},
        }, "required": ["topic"]},
    }},
]
